@{
  AllNodes = @(@{
    ...
    Lability_Resource = @('SQLServer2012','SQLServer2012SP4','SQLServer2012SP4GDR','SQLServer2012SP4GDRHotfix','SQLServer2017','SQLServer2017CU14','SSMS1791','SSMS1810','NetFx472')
  },@{
    NodeName = 'CHWK01'
    Network = @(@{
      SwitchName = 'CHICAGO'
